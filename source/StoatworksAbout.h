/*
 * Stoatworks Labs - About window data for crumple.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Crumple is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only crumple
 ...
 * five, and Crumple.cpp static_asserts the run so the change cannot land
 * silently.
 */
#pragma once
...
{
    inline constexpr auto name = "crumple";
    inline constexpr auto slug = "crumple";
    inline constexpr auto hook = "Crumpled paper for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/crumple/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/crumple";
